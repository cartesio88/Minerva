...
public:
	MAORenderable3DLine(const std::string& name, float size, int r, int g, int b);
	MAORenderable3DLine(const std::string& name, float size, int r, int g, int b, MAOPositionator3D& mao1, MAOPositionator3D& mao2);
